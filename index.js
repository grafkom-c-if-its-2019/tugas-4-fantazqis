(function() {
  ...
  var verticesHuruf = new Float32Array([
    //x,y,z           //r,g,b
    -0.1, 0.5, 0.0, 2.0,1.0,0.0,
    -0.1,-0.5, 0.0, 0.7,1.0,0.6,
    0.1, -0.5, 0.0, 0.3,1.0,0.6,
    0.1, 0.5, 0.0, 1.0,1.0,0.0,
    0.4, 0.5, 0.0, 0.4,0.0,1.0,
  ]);
  ...
  // 0.1, 0.5, 0.0, 1.0,1.0,0.0,
  // 0.4, 0.5, 0.0, 0.4,0.0,1.0,
  // 0.4, 0.8, 0.0, 1.0,1.0,0.5,
  // -0.4, 0.8, 0.0, 0.2,0.0,1.0,
  // -0.4, 0.5, 0.0, 1.0, 0.2, 0.5,
  // -0.1, 0.5, 0.0, 0.3, 0.5, 0.7
  ...
  */
  ...
  function render(){
    ...
    gl.uniform1i(flagUniformLocation, flag);
    gl.uniform1i(fFlagUniformLocation, flag);
    gl.drawArrays(gl.TRIANGLE_FAN, 0, nHuruf);
  ...
  function draw(){
    ...
    ac = glMatrix.vec3.fromValues(0.17, 0.41, 0.03);
